    ...
    <div className="fixed bottom-6 right-6 z-50">
      {!isOpen ? (
        <button
          ...
          className="group relative h-16 w-16 rounded-full bg-gradient-to-br from-green-500 to-emerald-600 flex items-center justify-center shadow-2xl shadow-green-500/30 transition-all duration-300 hover:scale-110"
        >
        ...
        <div className="w-[360px] h-[620px] overflow-hidden rounded-[28px] border border-white/10 bg-[#0B1120]/95 backdrop-blur-2xl shadow-[0_20px_80px_rgba(0,0,0,0.7)] flex flex-col">
          ...
          <div
            ref={scrollRef}
            className="flex-1 overflow-y-auto px-4 py-5 space-y-4 bg-gradient-to-b from-[#050816] to-[#0B1120] scrollbar-thin"
            style={{
              scrollbarWidth: "none",
            }}
          >
